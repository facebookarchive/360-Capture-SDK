...
namespace FBCapture { namespace Video {
	...
	{
	public:
		bool encodeMain(const void* texturePtr, const wstring& fullSavePath, int fps, bool needFlipping);
		bool flushEncodedImages();
		void saveScreenShot(const void* texturePtr, const wstring& fullSavePath, bool needFlipping);
	...
	protected:
		AMF_RESULT initialization(const void* texturePtr, const wstring& fullSavePath, int fps);
		AMF_RESULT fillSurface(amf::AMFContext *context, amf::AMFSurface *surface, bool needFlipping);
	};
}}